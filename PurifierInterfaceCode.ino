...
void solenoidturnon(unsigned long time) 
{
  ...
  if (timeNow - lastTimeButtonPressed4waterflow > time) {
  lastTimeButtonPressed4waterflow = timeNow;
  digitalWrite(A4,LOW);
}
 }
...
{
  unsigned long timeNow = millis();
  if (timeNow - lastTimeButtonPressed4debounce > debounceDelay) {
    lastTimeButtonPressed4debounce = timeNow;
    if (button1Pressed){
...
if (button1Pressed) {
  ...
  if (button2Pressed || button3Pressed || button4Pressed) 
  {
    button2Pressed = button3Pressed = button4Pressed = false;
  }
...
if (button2Pressed) {
  ...
  if (button1Pressed || button3Pressed || button4Pressed) 
  {
    button1Pressed = button3Pressed = button4Pressed = false;
  }
...
if (button3Pressed) {
  ...
  if (button2Pressed || button1Pressed || button4Pressed) 
  {
    button2Pressed = button1Pressed = button4Pressed = false;
  }
